...
/**
 * Interfaz de mapeo para convertir entre entidades de empresa y DTOs de
 * información.
...
public interface IEnterpriseSearchMapper {
    ...
    /**
     * Convierte una lista de proyecciones de información de empresa a una lista de
     * DTOs.
     *
     * @param enterpriseInfo lista de proyecciones con información básica de
     *                       empresas
    ...
    default Enterprise toEnterprise(EnterpriseEntity enterpriseEntity) {
        ...
        return Enterprise.builder()
                ...
                // .subjects(
                //         enterpriseEntity.getSubjects().stream()
                ...
                /**Para evitar otro golpe, mejor déjalo defensivo:*/
                .subjects(
                        enterpriseEntity.getSubjects() == null ? List.of()
                                : enterpriseEntity.getSubjects().stream()
                                        .map(subject -> Subject.builder()
                                                .id(subject.getId())
                                                .code(subject.getCode())
